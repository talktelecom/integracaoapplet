...
//Retorna do método para pedir recados.
//Retornos
//Aloca Vox Recado Ok.
...
//Retorno do Método para ouvir recado.
//Retornos
//Play Vox Ok.
//Erro Play Vox.
...
function doRingExternoPower(msg, tel, codcli)
{
	...
	//StatusUpdate(msg + " " + tel + " Código - " + codcli);
	//alert(msg);
}
...
function doAtendeuExternoPower(msg, telA, codcli, codcamp, telB, nome, codtel, codcampcli,canal)
{
	...
	StatusUpdate(msg + " " + telA + " " + telB + " Código - " + codcli+ "Canal:"+canal);
	BtnEnabled();
	//alert(msg);
}
...
function doAtendeuUraPower(msg, telA, codcli, codcamp, telB, nome, codtel, codcampcli,canal)
{
	...
	//StatusUpdate(msg + " " + telA + " " + telB + " Código - " + codcli );
	StatusUpdate(msg + " " + telA + " " + telB + " Código - " + codcli + " Canal - " + canal);
	BtnEnabled();
	//alert(msg);
}

// Retorno para Informação Estatística
...
function doAgenteLivre(msg)
{
	...
	if(nAtendeu != 0)
	{
		StatusUpdate("Chamada " + nAtendeu + " não atendida.");
		nAtendeu = 0;
	}
...
{
	alert('doIntervalosDescricao - Descrição ' + msg + " Id " +intervaloId + " Produtivo " + Produtivo);
	StatusUpdate(msg);
}
...
//Estes métodos retornam os ramais um a um conforme recebimento.
...
//FIm dos métodos que retornam os ramais um a um conforme recebimento.
